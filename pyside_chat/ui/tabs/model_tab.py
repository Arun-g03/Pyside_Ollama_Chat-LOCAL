...
class ModelTab(QWidget):
    ...
    # Signals
    # Emitted when user requests to pull a model
    model_pull_requested = Signal(str)
    # Emitted when user requests to remove a model
    model_remove_requested = Signal(str)
    # Emitted when user requests to update a model
    model_update_requested = Signal(str)
    ...
    def remove_selected_model(self):
        ...
        if not current_item:
            QMessageBox.warning(
                self, "Warning", "Please select a model to remove")
            return
    ...
    def update_selected_model(self):
        ...
        if not current_item:
            QMessageBox.warning(
                self, "Warning", "Please select a model to update")
            return

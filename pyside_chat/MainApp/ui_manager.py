...
from pyside_chat.ui.styles.styles import dark_stylesheet, light_stylesheet
...
class UIManager:
    ...
    def setup_ui(self, conversation_manager, summarization_service, memory_enabled, memory_service=None):
        ...
        try:
            ...
            self.main_window.setWindowTitle("Ollama Chat - Local LLM Chat Application")
            ...
            if memory_enabled:
                ...
                if hasattr(self.memory_tab, 'set_conversation_service'):
                    self.memory_tab.set_conversation_service(conversation_manager)
            ...
            logger.info("[ID:0229] UI setup completed successfully")
            
        except Exception as e:
            logger.error(f"[ID:0228] Error setting up UI: {e}")
            raise
    ...
    def setup_menu_bar(self):
        ...
        try:
            ...
            new_conversation_action = QAction("&New Conversation", self.main_window)
            ...
            refresh_models_action = QAction("&Refresh Models", self.main_window)
            ...
            logger.info("[ID:0227] Menu bar setup completed successfully")
            
        except Exception as e:
            logger.error(f"[ID:0226] Error setting up menu bar: {e}")
            raise
    ...
    def apply_theme(self, theme: str = "Dark"):
        ...
        try:
            ...
            logger.info(f"[ID:0225] Theme applied: {theme}")
            
        except Exception as e:
            logger.error(f"[ID:0224] Error applying theme: {e}")
    ...
    def update_status(self, message: str):
        ...
        try:
            ...
            logger.error(f"[ID:0223] Error updating status: {e}")
    ...
    def show_about_dialog(self):
        ...
        try:
            ...
            logger.error(f"[ID:0222] Error showing about dialog: {e}")
    ...
    def show_clear_chat_dialog(self) -> bool:
        ...
        try:
            ...
            logger.error(f"[ID:0221] Error showing clear chat dialog: {e}")
            return False 